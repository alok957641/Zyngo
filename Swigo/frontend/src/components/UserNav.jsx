...
function UserNav() {
  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-4 sm:gap-6">          
            ...
            {/* Orders (Visible on Desktop only) */}
            {userData && (
              ...
              <div className="relative">
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-2xl border p-2 z-50">
                    ...
                    {/* Orders (Mobile Only inside dropdown) */}
      ...
      {isSearchOpen && (
        <div className="fixed top-0 left-0 w-full bg-white shadow-xl z-50 p-4 lg:hidden border-b-4 border-orange-500">
