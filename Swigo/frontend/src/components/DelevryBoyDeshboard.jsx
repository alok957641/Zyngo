...
const customerIcon = new L.Icon({
    iconUrl: 'https://cdn-icons-png.flaticon.com/512/1277/1277337.png',
    iconSize: [30, 30],
    iconAnchor: [15, 30]
});
...
function DelevryBoyDeshboard() {
        ...
        const restoreUser = async () => {
            ...
            try {
                ...
                const res = await axios.get(
                    `${serverurl}/api/user/getcurruser`,
                    {
    ...
    const fetchEverything = async () => {
        ...
        try {
            ...
            const [statsRes, missionRes, activeRes] = await Promise.all([
                ...
                axios.get(
                    `${serverurl}/api/order/rider-stats`,
                    { withCredentials: true }
                ),

                axios.get(
                    `${serverurl}/api/order/get-delivery-assignments`,
                    { withCredentials: true }
                ),
            ...
            if (missionRes.data.success) {
                setAvailableMissions(missionRes.data.orders || []);
            }
    ...
    const handleAccept = async (id) => {
        ...
        try {
            ...
            triggerMessage(
                "Order already taken by another node.",
                true
            );
        ...
        <div className="min-h-screen bg-[#020617] font-sans pb-32 text-slate-200">
            ...
            <header className="bg-[#090d1f]/60 border-b border-white/[0.03] pt-12 pb-4 px-6 backdrop-blur-md sticky top-0 z-40">
                ...
                <div className="flex justify-between items-center max-w-5xl mx-auto">
                    ...
                    <div>
                        <p className="text-[8px] font-black text-orange-500 uppercase tracking-[2px]">
                            Rider Node
                        </p>

                        <h2 className="text-sm font-black text-white uppercase">
                            {userData?.fullname || "R-NODE"}
                        </h2>
                    </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="h-8 w-8 flex items-center justify-center bg-white/[0.03] rounded-lg hover:text-red-500"
                        >
                            <FiLogOut size={14} />
                        </button>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {activeOrder ? (
                        ...
                        >
                            ...
                            <h3 className="text-xs font-black text-white uppercase mb-4">
                        ...
                        <div className="space-y-3">
                            ...
                            {availableMissions.map((m) => (
                                ...
                                <motion.div
                                    key={m._id}
                                    className="p-4 bg-white/[0.01] border border-white/5 rounded-2xl flex justify-between items-center"
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-slate-500">
                                            {m.order?.delevryAddress?.text?.slice(0, 30)}
                                        </p>
                                    ...
                                    <button
                                        ...
                                        className="bg-orange-600 px-4 py-2 rounded-xl text-[10px] font-black uppercase"
                                    >
                                        Accept
                                    </button>
